...
class AppColors {
  static const primary = Color.fromARGB(255, 3, 72, 219);
  ...
  static const lighSecondaryText = Color.fromARGB(255, 112, 116, 133);
  ...
  static const lightDisabled = Color.fromARGB(255, 112, 116, 133);
  static const darkDisabledText = Color.fromARGB(255, 141, 153, 204);
  static const lightDisabledText = Color.fromARGB(255, 84, 91, 121);
  static const erroBg = Color.fromARGB(255, 126, 12, 12);
  static const erroDialogText = Color.fromARGB(255, 241, 187, 187);
  static const alertBg = Color.fromARGB(255, 206, 171, 16);
